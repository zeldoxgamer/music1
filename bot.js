...
client.on('ready', () => {
  client.user.setGame('رمضان كريم +help | +inv','https://www.twitch.tv/peery13');
});
...
return message.reply("**لا يمكنك تغيير الاسم يجب عليك الانتظآر لمدة سا��تين . **");
} else
  if (message.content.startsWith(adminprefix + 'setavatar')) {
client.user.setAvatar(argresult);
  message.channel.sendMessage(`**${argresult}** : تم ��غير صورة البوت`);
      } else     
